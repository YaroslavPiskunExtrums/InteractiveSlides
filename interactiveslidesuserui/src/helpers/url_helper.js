...
export const POST_LOGIN =  `${window.location.hostname.indexOf("app.slidex.ai") !== -1  ? `${window.location.origin}/addin` : "http://localhost:5000"}/api/auth/sign-in`;

export const POST_REGISTER = "http://localhost:8080/api/auth/register";
